...
```javascript
import grev from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-grev@v0.2.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-grev@v0.2.1-deno/mod.js';
```
